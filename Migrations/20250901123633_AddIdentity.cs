    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__departme__72E12F1A4FF70281", x => x.name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    department = table.Column<string>(type: "varchar(45)", unicode: false, maxLength: 45, nullable: false),
                    manager = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__employee__72E12F1AD4D247B5", x => x.name);
                    table.ForeignKey(
